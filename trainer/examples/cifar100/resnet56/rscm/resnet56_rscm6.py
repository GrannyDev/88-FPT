"""ResNet56/CIFAR100 RSCM6 QAT recipe with sigmoid staircase weight quantization.
...
OUTPUT_DIR = "results/RESNET56_CIFAR100_RSCM6/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "resnet56_rscm6_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
