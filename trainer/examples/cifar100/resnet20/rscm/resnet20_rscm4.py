"""ResNet20/CIFAR100 RSCM4 QAT recipe with sigmoid staircase weight quantization.
...
OUTPUT_DIR = "results/RESNET20_CIFAR100_RSCM4/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "resnet20_rscm4_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
