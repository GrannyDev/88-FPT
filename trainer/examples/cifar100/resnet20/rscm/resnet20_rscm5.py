"""ResNet20/CIFAR100 RSCM5 QAT recipe with sigmoid staircase weight quantization.
...
OUTPUT_DIR = "results/RESNET20_CIFAR100_RSCM5/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "resnet20_rscm5_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
