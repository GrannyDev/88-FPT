"""ResNet20/CIFAR100 INT4 QAT recipe with power-of-two deployment scales.
...
OUTPUT_DIR = "results/RESNET20_CIFAR100_INT5/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "resnet20_int5_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
