...
OUTPUT_DIR = "results/MOBILENETV2_RSCM5/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "mobilenetv2_rscm5_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
SEED = 42
...
RSCM_SET_PATH = str(Path(__file__).resolve().parents[3] / "sets" / "RSCM5.txt")
