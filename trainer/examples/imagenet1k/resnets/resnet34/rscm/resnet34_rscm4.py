...
OUTPUT_DIR = "results/RESNET34_RSCM4/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "resnet34_rscm4_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
...
MASTER_PORT = "12355"
RSCM_SET_PATH = str(Path(__file__).resolve().parents[4] / "sets" / "RSCM4.txt")
