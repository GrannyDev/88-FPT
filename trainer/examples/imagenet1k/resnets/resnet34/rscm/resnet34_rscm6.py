...
from hatorch.models import ResNet34
...
OUTPUT_DIR = "results/RESNET34_RSCM6/"
FINAL_MODEL_PATH = str(Path(OUTPUT_DIR) / "resnet34_rscm6_final.pt")
DEVICE = "cuda"
BATCH_SIZE = 256
...
MASTER_PORT = "12355"
RSCM_SET_PATH = str(Path(__file__).resolve().parents[4] / "sets" / "RSCM6.txt")

EPOCHS = 30
EXTRA_EPOCHS = 0
CALIBRATION_EPOCHS = 1
SWITCH_BN_TO_RUNNING_STATS_EPOCH = 8
FREEZE_BN_RUNNING_STATS_EPOCH = 8
