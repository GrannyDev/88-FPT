...
module lut6_2_carry_3dd_multiplier (
    ...
    // requested coeffs sorted = [-63, -60, -59, -58, -57, -55, -53, -52, -50, -49, -48, -42, -41, -37, -36, -33, -31, -28, -27, -26, -25, -23, -21, -20, -18, -17, -16, -10, -9, -5, -4, -1, 1, 4, 5, 6, 7, 9, 11, 12, 14, 15, 16, 22, 23, 27, 28, 31, 33, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 54, 55, 59, 60, 63]
    // selector coeffs        = [11, 14, -5, 5, 12, 16, -4, 4, 7, 6, -9, 9, 15, 22, -1, 1, 43, 46, -37, 37, 44, 48, -36, 36, 39, 38, -41, 41, 47, 54, -33, 33, -53, -50, 59, -59, -52, -48, 60, -60, -57, -58, 55, -55, -49, -42, 63, -63, -21, -18, 27, -27, -20, -16, 28, -28, -25, -26, 23, -23, -17, -10, 31, -31]
    // left add1 coeffs       = [1, 5, -7, -3]
    ...
    localparam [63:0] LEFT_ADD1_BIT_0_S_INIT =
        ...
        (LEFT_ADD1_SEL_ROW_1 & (LUT_I2 ^ LUT_I3)) |
        (LEFT_ADD1_SEL_ROW_2 & (LUT_I2 ^ ~LUT_I4)) |
        (LEFT_ADD1_SEL_ROW_3 & (LUT_I2 ^ ~LUT_I3));
