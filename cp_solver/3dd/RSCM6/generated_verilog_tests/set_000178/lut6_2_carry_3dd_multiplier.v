...
module lut6_2_carry_3dd_multiplier (
    ...
    localparam integer RIGHT_Y_BW = 7;
    ...
    // requested coeffs sorted = [-63, -62, -61, -60, -59, -58, -56, -54, -42, -40, -38, -37, -36, -35, -34, -33, -31, -30, -29, -28, -27, -26, -24, -22, -10, -8, -6, -5, -4, -3, -2, -1, 1, 2, 3, 4, 5, 6, 8, 10, 22, 24, 26, 27, 28, 29, 30, 31, 33, 34, 35, 36, 37, 38, 40, 42, 54, 56, 58, 59, 60, 61, 62, 63]
    // selector coeffs        = [-40, -36, 36, 40, -8, -4, 4, 8, 24, 28, -28, -24, 56, 60, -60, -56, -42, -37, 37, 42, -10, -5, 5, 10, 22, 27, -27, -22, 54, 59, -59, -54, -34, -33, 33, 34, -2, -1, 1, 2, 30, 31, -31, -30, 62, 63, -63, -62, -38, -35, 35, 38, -6, -3, 3, 6, 26, 29, -29, -26, 58, 61, -61, -58]
    // left add1 coeffs       = [4, 5, 1, 3]
    // right add1 coeffs      = [-1, 0, 1, 2]
    ...
    localparam [63:0] LEFT_ADD1_BIT_0_S_INIT =
        (LEFT_ADD1_SEL_ROW_0 & (LUT_I4 ^ 64'h0000000000000000)) |
        (LEFT_ADD1_SEL_ROW_1 & (LUT_I2 ^ LUT_I4)) |
    ...
    assign right_add1_s[7] = 1'b0;
    assign right_add1_di[7] = 1'b0;
    ...
    assign right_y = right_add1_o[6:0];
