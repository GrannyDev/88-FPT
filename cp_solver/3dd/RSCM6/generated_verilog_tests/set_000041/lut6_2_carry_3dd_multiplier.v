...
module lut6_2_carry_3dd_multiplier (
    ...
    localparam integer RIGHT_Y_BW = 8;
    ...
    // requested coeffs sorted = [-59, -58, -53, -52, -43, -42, -37, -36, -35, -34, -31, -30, -29, -28, -25, -24, -23, -22, -19, -18, -17, -16, -13, -12, -11, -10, -7, -6, -5, -4, -1, 0, 1, 2, 5, 6, 7, 8, 11, 12, 13, 14, 17, 18, 19, 20, 23, 24, 25, 26, 29, 30, 31, 32, 35, 36, 37, 38, 43, 44, 53, 54, 59, 60]
    // selector coeffs        = [7, 11, -5, -1, 8, 12, -4, 0, 1, 5, -11, -7, 2, 6, -10, -6, 19, 35, -29, -13, 20, 36, -28, -12, 13, 29, -35, -19, 14, 30, -34, -18, 23, 43, -37, -17, 24, 44, -36, -16, 17, 37, -43, -23, 18, 38, -42, -22, 31, 59, -53, -25, 32, 60, -52, -24, 25, 53, -59, -31, 26, 54, -58, -30]
    // left add1 coeffs       = [1, 4, 5, 7]
    // right add1 coeffs      = [3, 4, -3, -2]
    ...
    localparam [63:0] LEFT_ADD1_BIT_0_S_INIT =
        ...
        (LEFT_ADD1_SEL_ROW_1 & (LUT_I4 ^ ~LUT_I3)) |
        (LEFT_ADD1_SEL_ROW_2 & (LUT_I2 ^ LUT_I3)) |
        (LEFT_ADD1_SEL_ROW_3 & (~LUT_I2 ^ LUT_I4));
    localparam [63:0] LEFT_ADD1_BIT_0_DI_INIT =
        (LEFT_ADD1_SEL_ROW_0 & (LUT_I2)) |
        (LEFT_ADD1_SEL_ROW_1 & (LUT_I4)) |
    ...
    wire [7:0] right_add1_s;
    wire [7:0] right_add1_di;
    wire [7:0] right_add1_o;
    wire [7:0] right_add1_co;
    ...
    localparam [63:0] RIGHT_ADD1_BIT_0_S_INIT =
        ...
        (RIGHT_ADD1_SEL_ROW_1 & (LUT_I4 ^ 64'h0000000000000000)) |
    ...
    assign right_y = right_add1_o[7:0];
    ...
    localparam [63:0] ADD3_BIT_0_S_INIT =
        (ADD3_SEL_ROW_0 & (LUT_I2 ^ LUT_I4)) |
        (ADD3_SEL_ROW_1 & (LUT_I3 ^ LUT_I4)) |
        (ADD3_SEL_ROW_2 & (~LUT_I3 ^ LUT_I4)) |
        (ADD3_SEL_ROW_3 & (~LUT_I2 ^ LUT_I4));
    localparam [63:0] ADD3_BIT_0_DI_INIT =
        (ADD3_SEL_ROW_0 & (LUT_I2)) |
        (ADD3_SEL_ROW_1 & (LUT_I3)) |
        (ADD3_SEL_ROW_2 & (~LUT_I3)) |
