...
module lut6_2_carry_3dd_multiplier (
    ...
    // requested coeffs sorted = [-58, -56, -54, -53, -52, -51, -50, -49, -47, -46, -45, -44, -43, -42, -40, -38, -32, -28, -26, -25, -21, -19, -18, -14, -10, -8, -6, -5, -4, -3, -2, -1, 1, 2, 3, 4, 5, 6, 8, 10, 14, 18, 19, 21, 25, 26, 28, 32, 38, 40, 42, 43, 44, 45, 46, 47, 49, 50, 51, 52, 53, 54, 56, 58]
    // selector coeffs        = [-21, -18, 18, 21, -19, -14, 14, 19, -28, -32, 32, 28, -25, -26, 26, 25, -45, -42, 42, 45, -43, -38, 38, 43, -52, -56, 56, 52, -49, -50, 50, 49, 51, 54, -54, -51, 53, 58, -58, -53, 44, 40, -40, -44, 47, 46, -46, -47, 3, 6, -6, -3, 5, 10, -10, -5, -4, -8, 8, 4, -1, -2, 2, 1]
    // left add1 coeffs       = [3, 6, -6, 0]
    // right add1 coeffs      = [3, 5, -4, -1]
    ...
    // left_add1: pack mode: direct-left
    // left_add1: correction carry-in is left_sel[1]
    wire [11:0] left_add1_s;
    wire [11:0] left_add1_di;
    wire [11:0] left_add1_o;
    wire [11:0] left_add1_co;
    wire left_add1_carry_init = left_sel[1];
    ...
    localparam [63:0] LEFT_ADD1_BIT_0_S_INIT =
        (LEFT_ADD1_SEL_ROW_0 & (LUT_I3 ^ LUT_I2)) |
        (LEFT_ADD1_SEL_ROW_1 & (LUT_I3 ^ LUT_I4)) |
        (LEFT_ADD1_SEL_ROW_2 & (LUT_I3 ^ ~LUT_I5)) |
        (LEFT_ADD1_SEL_ROW_3 & (LUT_I3 ^ ~LUT_I3));
    localparam [63:0] LEFT_ADD1_BIT_0_INIT =
        LEFT_ADD1_BIT_0_S_INIT;

    wire left_add1_unused_o5_0;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_0_INIT)
    ) left_add1_lut_bit_0 (
        .O6(left_add1_s[0]),
        .O5(left_add1_unused_o5_0),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[0]),
        .I3(1'b0),
    ...
    localparam [63:0] LEFT_ADD1_BIT_1_INIT =
        LEFT_ADD1_BIT_1_S_INIT;

    wire left_add1_unused_o5_1;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_1_INIT)
    ) left_add1_lut_bit_1 (
        .O6(left_add1_s[1]),
        .O5(left_add1_unused_o5_1),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[1]),
        .I3(x[0]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_2_INIT =
        LEFT_ADD1_BIT_2_S_INIT;

    wire left_add1_unused_o5_2;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_2_INIT)
    ) left_add1_lut_bit_2 (
        .O6(left_add1_s[2]),
        .O5(left_add1_unused_o5_2),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[2]),
        .I3(x[1]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_3_INIT =
        LEFT_ADD1_BIT_3_S_INIT;

    wire left_add1_unused_o5_3;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_3_INIT)
    ) left_add1_lut_bit_3 (
        .O6(left_add1_s[3]),
        .O5(left_add1_unused_o5_3),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[3]),
        .I3(x[2]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_4_INIT =
        LEFT_ADD1_BIT_4_S_INIT;

    wire left_add1_unused_o5_4;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_4_INIT)
    ) left_add1_lut_bit_4 (
        .O6(left_add1_s[4]),
        .O5(left_add1_unused_o5_4),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[4]),
        .I3(x[3]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_5_INIT =
        LEFT_ADD1_BIT_5_S_INIT;

    wire left_add1_unused_o5_5;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_5_INIT)
    ) left_add1_lut_bit_5 (
        .O6(left_add1_s[5]),
        .O5(left_add1_unused_o5_5),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[5]),
        .I3(x[4]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_6_INIT =
        LEFT_ADD1_BIT_6_S_INIT;

    wire left_add1_unused_o5_6;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_6_INIT)
    ) left_add1_lut_bit_6 (
        .O6(left_add1_s[6]),
        .O5(left_add1_unused_o5_6),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[5]),
        .I3(x[5]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_7_INIT =
        LEFT_ADD1_BIT_7_S_INIT;

    wire left_add1_unused_o5_7;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_7_INIT)
    ) left_add1_lut_bit_7 (
        .O6(left_add1_s[7]),
        .O5(left_add1_unused_o5_7),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[5]),
        .I3(x[5]),
    ...
    localparam [63:0] LEFT_ADD1_BIT_8_INIT =
        LEFT_ADD1_BIT_8_S_INIT;

    wire left_add1_unused_o5_8;
    LUT6_2 #(
        .INIT(LEFT_ADD1_BIT_8_INIT)
    ) left_add1_lut_bit_8 (
        .O6(left_add1_s[8]),
        .O5(left_add1_unused_o5_8),
        .I0(left_sel[0]),
        .I1(left_sel[1]),
        .I2(x[5]),
        .I3(x[5]),
    ...
    localparam [63:0] RIGHT_ADD1_BIT_0_S_INIT =
        ...
        (RIGHT_ADD1_SEL_ROW_2 & (~LUT_I4 ^ 64'h0000000000000000)) |
