...
module lut6_2_carry_3dd_multiplier (
    ...
    // requested coeffs sorted = [-164, -160, -140, -137, -136, -132, -131, -130, -129, -128, -127, -125, -124, -122, -120, -119, -112, -110, -108, -105, -104, -99, -98, -97, -95, -93, -92, -90, -88, -87, -80, -78, -68, -64, -44, -41, -40, -36, -35, -34, -33, -32, -31, -29, -28, -26, -24, -23, -16, -14, -12, -9, -8, -4, -3, -2, -1, 0, 1, 3, 4, 6, 8, 9, 16, 18, 20, 23, 24, 28, 29, 30, 31, 32, 33, 35, 36, 38, 40, 41, 48, 50, 52, 55, 56, 61, 62, 63, 65, 67, 68, 70, 72, 73, 80, 82, 92, 96, 116, 119, 120, 124, 125, 126, 127, 128, 129, 131, 132, 134, 136, 137, 144, 146, 148, 151, 152, 157, 158, 159, 161, 163, 164, 166, 168, 169, 176, 178]
    // selector coeffs        = [40, 48, 0, 24, 41, 50, -4, 23, 31, 30, 36, 33, 35, 38, 20, 29, 72, 80, 32, 56, 73, 82, 28, 55, 63, 62, 68, 65, 67, 70, 52, 61, 136, 144, 96, 120, 137, 146, 92, 119, 127, 126, 132, 129, 131, 134, 116, 125, 168, 176, 128, 152, 169, 178, 124, 151, 159, 158, 164, 161, 163, 166, 148, 157, -120, -112, -160, -136, -119, -110, -164, -137, -129, -130, -124, -127, -125, -122, -140, -131, -88, -80, -128, -104, -87, -78, -132, -105, -97, -98, -92, -95, -93, -90, -108, -99, -24, -16, -64, -40, -23, -14, -68, -41, -33, -34, -28, -31, -29, -26, -44, -35, 8, 16, -32, -8, 9, 18, -36, -9, -1, -2, 4, 1, 3, 6, -12, -3]
    // left add1 coeffs       = [2, 4, 8, 10, -8, -6, -2, 0]
    // right add1 coeffs      = [8, 9, -1, 3]
    ...
    localparam [63:0] LEFT_ADD1_BIT_0_S_INIT =
        ...
        (LEFT_ADD1_SEL_ROW_5 & (LUT_I3 ^ ~LUT_I4)) |
        (LEFT_ADD1_SEL_ROW_6 & (~LUT_I3 ^ 64'h0000000000000000)) |
        (LEFT_ADD1_SEL_ROW_7 & (LUT_I3 ^ ~LUT_I3));
    ...
    localparam [63:0] RIGHT_ADD1_BIT_0_S_INIT =
        (RIGHT_ADD1_SEL_ROW_0 & (LUT_I4 ^ 64'h0000000000000000)) |
        (RIGHT_ADD1_SEL_ROW_1 & (LUT_I2 ^ LUT_I4)) |
        (RIGHT_ADD1_SEL_ROW_2 & (~LUT_I2 ^ 64'h0000000000000000)) |
        (RIGHT_ADD1_SEL_ROW_3 & (~LUT_I2 ^ LUT_I3));
