...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-9, -8, -7, -6, -5, -4, -3, -2, 1, 2, 3, 4, 7, 8, 9, 10]
    // selector coeffs        = [1, 7, -9, -5, 2, 8, -8, -4, 3, 9, -7, -3, 4, 10, -6, -2]
    // add1 coeffs            = [-1, 0, 1, 2]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        ...
        (ADD1_SEL_ROW_1 & (~LUT_I2 ^ LUT_I2)) |
        (ADD1_SEL_ROW_2 & (LUT_I2 ^ 64'hFFFFFFFFFFFFFFFF)) |
        (ADD1_SEL_ROW_3 & (LUT_I3 ^ 64'hFFFFFFFFFFFFFFFF));
    localparam [63:0] ADD1_BIT_0_DI_INIT =
        (ADD1_SEL_ROW_0 & (~LUT_I2)) |
        (ADD1_SEL_ROW_1 & (~LUT_I2)) |
        (ADD1_SEL_ROW_2 & (LUT_I2)) |
