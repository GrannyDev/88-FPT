...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-12, -10, -8, -6, -5, -4, -2, -1, 1, 2, 4, 5, 6, 8, 10, 12]
    // selector coeffs        = [-10, -12, -2, -8, -5, -6, -1, -4, 5, 6, 1, 4, 10, 12, 2, 8]
    // add1 coeffs            = [-2, -1, 1, 2]
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        ...
        (ADD2_SEL_ROW_3 & (LUT_I4 ^ 64'hFFFFFFFFFFFFFFFF));
