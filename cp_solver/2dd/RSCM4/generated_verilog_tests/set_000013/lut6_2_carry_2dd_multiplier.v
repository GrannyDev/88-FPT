...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-9, -8, -7, -5, -4, -3, -2, -1, 1, 2, 3, 4, 5, 7, 8, 9]
    // selector coeffs        = [4, 5, -1, 3, 8, 9, -2, 7, -8, -7, 2, -9, -4, -3, 1, -5]
    // add1 coeffs            = [1, 2, -2, -1]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        ...
        (ADD1_SEL_ROW_3 & (~LUT_I2 ^ 64'h0000000000000000));
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        (ADD2_SEL_ROW_0 & (LUT_I3 ^ 64'h0000000000000000)) |
        (ADD2_SEL_ROW_1 & (LUT_I3 ^ LUT_I4)) |
        (ADD2_SEL_ROW_2 & (~LUT_I2 ^ 64'h0000000000000000)) |
        (ADD2_SEL_ROW_3 & (~LUT_I4 ^ LUT_I3));
