...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-13, -11, -8, -6, -5, -3, -2, 0, 2, 3, 4, 5, 7, 8, 9, 12]
    // selector coeffs        = [-11, -8, -6, -13, -3, 0, -2, -5, 5, 8, 2, 3, 9, 12, 4, 7]
    // add1 coeffs            = [-3, -1, 1, 2]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        (ADD1_SEL_ROW_0 & (LUT_I2 ^ ~LUT_I4)) |
        (ADD1_SEL_ROW_1 & (LUT_I2 ^ ~LUT_I3)) |
        (ADD1_SEL_ROW_2 & (~LUT_I2 ^ LUT_I3)) |
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        ...
        (ADD2_SEL_ROW_1 & (LUT_I3 ^ LUT_I5)) |
        (ADD2_SEL_ROW_2 & (LUT_I3 ^ ~LUT_I2)) |
