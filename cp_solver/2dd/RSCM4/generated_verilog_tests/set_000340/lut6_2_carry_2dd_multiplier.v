...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-10, -9, -8, -7, -4, -3, -2, -1, 2, 3, 4, 5, 6, 7, 8, 9]
    // selector coeffs        = [2, 6, -10, -4, 3, 7, -9, -3, 4, 8, -8, -2, 5, 9, -7, -1]
    // add1 coeffs            = [-2, -1, 0, 1]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        (ADD1_SEL_ROW_0 & (LUT_I3 ^ ~LUT_I4)) |
        (ADD1_SEL_ROW_1 & (LUT_I2 ^ ~LUT_I3)) |
        (ADD1_SEL_ROW_2 & (~LUT_I2 ^ LUT_I2)) |
        (ADD1_SEL_ROW_3 & (~LUT_I2 ^ LUT_I3));
