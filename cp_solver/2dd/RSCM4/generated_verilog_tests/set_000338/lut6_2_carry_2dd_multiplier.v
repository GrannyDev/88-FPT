...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-10, -8, -7, -6, -5, -4, -3, -1, 0, 2, 3, 5, 6, 8, 9, 11]
    // selector coeffs        = [3, 9, -7, -3, 5, 11, -5, -1, 0, 6, -10, -6, 2, 8, -8, -4]
    // add1 coeffs            = [1, 3, -2, 0]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        ...
        (ADD1_SEL_ROW_1 & (LUT_I3 ^ LUT_I2)) |
        (ADD1_SEL_ROW_2 & (~LUT_I3 ^ 64'h0000000000000000)) |
