...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-15, -12, -6, -5, -4, -3, -2, -1, 2, 3, 4, 6, 8, 10, 12, 15]
    // selector coeffs        = [2, 4, 8, 10, 3, 6, 12, 15, -3, -6, -12, -15, -1, -2, -4, -5]
    // add1 coeffs            = [2, 3, -3, -1]
    ...
    // add2: correction carry-in is constant 0
    wire [7:0] add2_s;
    wire [7:0] add2_di;
    wire [7:0] add2_o;
    wire [7:0] add2_co;
    wire add2_carry_init = 1'b0;
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        ...
        (ADD2_SEL_ROW_2 & (LUT_I4 ^ 64'h0000000000000000)) |
