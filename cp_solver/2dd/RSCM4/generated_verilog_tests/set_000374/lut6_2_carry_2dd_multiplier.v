...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-12, -10, -7, -6, -4, -3, -2, 0, 1, 2, 3, 4, 6, 8, 10, 12]
    // selector coeffs        = [2, -12, -10, -7, 6, -4, -6, -3, 10, 4, -2, 1, 12, 8, 0, 3]
    // add1 coeffs            = [-3, -1, 1, 2]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        ...
        (ADD1_SEL_ROW_1 & (~LUT_I2 ^ 64'h0000000000000000)) |
