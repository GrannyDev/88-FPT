...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-14, -9, -8, -7, -4, -2, -1, 0, 2, 3, 5, 6, 8, 9, 12, 14]
    // selector coeffs        = [12, 6, -4, 3, 14, 9, -2, 5, 2, -9, -14, -7, 8, 0, -8, -1]
    // add1 coeffs            = [2, 3, -3, 0]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        (ADD1_SEL_ROW_0 & (LUT_I2 ^ LUT_I2)) |
        (ADD1_SEL_ROW_1 & (LUT_I3 ^ LUT_I2)) |
        (ADD1_SEL_ROW_2 & (~LUT_I4 ^ LUT_I2)) |
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        (ADD2_SEL_ROW_0 & (LUT_I3 ^ LUT_I5)) |
        (ADD2_SEL_ROW_1 & (LUT_I3 ^ LUT_I2)) |
        (ADD2_SEL_ROW_2 & (LUT_I3 ^ ~LUT_I5)) |
        (ADD2_SEL_ROW_3 & (LUT_I3 ^ ~LUT_I4));
