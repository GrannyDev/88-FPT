...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-12, -11, -8, -6, -4, -3, -2, -1, 2, 3, 4, 5, 6, 9, 12, 13]
    // selector coeffs        = [2, 5, -4, -1, 4, 9, -8, -2, -6, -11, 12, 3, 6, 13, -12, -3]
    // add1 coeffs            = [1, 2, -3, 3]
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        (ADD2_SEL_ROW_0 & (LUT_I2 ^ LUT_I2)) |
        (ADD2_SEL_ROW_1 & (LUT_I4 ^ LUT_I3)) |
        (ADD2_SEL_ROW_2 & (~LUT_I3 ^ 64'h0000000000000000)) |
        (ADD2_SEL_ROW_3 & (~LUT_I2 ^ 64'h0000000000000000));
    localparam [63:0] ADD2_BIT_0_DI_INIT =
        (ADD2_SEL_ROW_0 & (LUT_I2)) |
        (ADD2_SEL_ROW_1 & (LUT_I4)) |
        (ADD2_SEL_ROW_2 & (~LUT_I3)) |
