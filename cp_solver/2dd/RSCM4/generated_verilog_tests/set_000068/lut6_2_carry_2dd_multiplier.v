...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-14, -10, -8, -7, -5, -4, -2, -1, 1, 2, 4, 5, 7, 8, 10, 14]
    // selector coeffs        = [1, 4, 5, 7, 2, 8, 10, 14, -2, -8, -10, -14, -1, -4, -5, -7]
    // add1 coeffs            = [1, 2, -2, -1]
    ...
    // add2: correction carry-in is add2_sel[0]
    wire [7:0] add2_s;
    wire [7:0] add2_di;
    wire [7:0] add2_o;
    wire [7:0] add2_co;
    wire add2_carry_init = add2_sel[0];
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        ...
        (ADD2_SEL_ROW_1 & (LUT_I3 ^ 64'hFFFFFFFFFFFFFFFF)) |
