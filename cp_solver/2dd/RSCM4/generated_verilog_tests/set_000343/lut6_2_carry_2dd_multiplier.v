...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-10, -9, -8, -7, -6, -5, -4, -3, 0, 1, 2, 3, 6, 7, 8, 9]
    // selector coeffs        = [0, 6, -10, -6, 1, 7, -9, -5, 2, 8, -8, -4, 3, 9, -7, -3]
    // add1 coeffs            = [-2, -1, 0, 1]
    ...
    localparam [63:0] ADD1_BIT_0_S_INIT =
        ...
        (ADD1_SEL_ROW_2 & (LUT_I4 ^ ~LUT_I4)) |
        (ADD1_SEL_ROW_3 & (LUT_I2 ^ 64'hFFFFFFFFFFFFFFFF));
