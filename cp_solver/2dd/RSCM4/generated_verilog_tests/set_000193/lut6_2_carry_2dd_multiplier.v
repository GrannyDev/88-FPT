...
module lut6_2_carry_2dd_multiplier (
    ...
    // requested coeffs sorted = [-13, -12, -9, -6, -5, -4, -2, -1, 2, 3, 4, 7, 8, 9, 11, 12]
    // selector coeffs        = [-6, -1, 7, 8, -9, -2, 11, 12, 9, 4, -13, -12, 3, 2, -5, -4]
    // add1 coeffs            = [2, 3, -3, -1]
    ...
    localparam [63:0] ADD2_BIT_0_S_INIT =
        ...
        (ADD2_SEL_ROW_2 & (LUT_I3 ^ ~LUT_I4)) |
        (ADD2_SEL_ROW_3 & (LUT_I3 ^ 64'hFFFFFFFFFFFFFFFF));
